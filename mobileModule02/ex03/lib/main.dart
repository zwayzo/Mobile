...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // ✅ New: holds error message, null means no error
...
Future<void> getData(String city) async {
  ...
  try {
    ...
    // ✅ API failure — network error, timeout, bad response, etc.
    setState(() {
      isLoadingWeather = false;
  ...
  // ✅ Single method handles both empty state and error state
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(getWeatherDescription(code), style: const TextStyle(fontSize: 22)),
          const SizedBox(height: 8),
          Text("$temp °C", style: const TextStyle(fontSize: 64, fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  leading: Text(date, style: const TextStyle(fontWeight: FontWeight.w600)),
